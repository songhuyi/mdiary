    ...
    <div className="min-h-screen flex dark:bg-stone-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-stone-100 to-stone-200 dark:from-stone-800 dark:to-stone-900 items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center relative z-10 animate-fade-in">
          ...
          <p className="text-sm text-stone-500 dark:text-stone-400">开始你的文字之旅</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 bg-white dark:bg-stone-900">
        <div className="w-full max-w-sm animate-fade-in-up">
          ...
          <h1 className="text-2xl font-serif text-stone-800 dark:text-stone-100 mb-8">注册</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm text-stone-600 dark:text-stone-400 mb-1.5">昵称</label>
              <input
                type="text"
                value={name}
          ...
          <p className="text-center text-sm text-stone-500 dark:text-stone-400 mt-6">
            已有账号？{" "}
            <Link href="/login" className="text-stone-700 dark:text-stone-300 hover:text-stone-900 dark:hover:text-white underline underline-offset-4">
              登录
            </Link>
          </p>
        </div>
